...
//operador ternario => (condicion logica)? agrego lo que quiero si se cumple la condicion : agrego lo que quiero si no se cumple la condicion ;

(perifericos.includes(productoParaBuscar))? document.write(`<p>El producto: ${productoParaBuscar}, SI Existe.</p>`) : document.write(`<p>El producto: ${productoParaBuscar}, no Existe.</p>`);
...
//buscar un elemto, Webcam 4K Logitech Brio
...
document.write(`<p>El producto: ${productoBuscado}.</p>`);
